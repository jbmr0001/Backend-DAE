...
public class ServicioCovidAppTest {
    ...
    */
    ...
    public void testVerPositivosQuincena(){
        ...
        Assertions.assertThat(servicioCovidApp.numPositivosQuincena(rastreador.getDni())).isEqualTo(3);
    ...
    public void testNotificarContactosCercanos() {
        ...
        servicioCovidApp.notificarContactosCercano(usuario1.getUuid(), lista, rastreador.getDni());
    ...
    public void testMediaContactosPositivo() {
        ...
        servicioCovidApp.notificarContactosCercano(usuario1.getUuid(), listaU, rastreador.getDni());
        servicioCovidApp.notificarContactosCercano(usuario2.getUuid(), listaU1, rastreador.getDni());
        
        Assertions.assertThat(servicioCovidApp.mediaContactosPositivo(rastreador.getDni())).isEqualTo(0);
